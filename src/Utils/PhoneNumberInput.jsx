...
export default function PhoneNumberInput() {
    ...
    return (
        <Autocomplete
            ...
            options={countries}
            autoHighlight
            value={selectedCountry} // تعيين الدولة المختارة
            onChange={handleCountryChange} // تحديث الدولة عند التغيير
            getOptionLabel={(option) => `${option.phone}+`} // عرض الرقم الدولي
            ...
            renderInput={(params) => (
                <TextField
                    ...
                    id="outlined-basic"
                    label={selectedCountry ? selectedCountry.label : ''}
                    type="text"
                    variant="outlined"
                    value={selectedCountry ? `+${selectedCountry.phone}` : ''} // عرض الرقم الدولي
                    onChange={() => {}} // لا تغيير في النص هنا
                />
            )}
        />
    );
...
const countries = [
    ...
    { code: 'VI', label: 'United States Virgin Islands', phone: '1-340' },
