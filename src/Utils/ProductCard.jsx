...
const ProductCard = ({image,name,price}) => {
  ...
  return (
    <Box sx={{position:"relative"}}>
        ...
        />
        <Stack sx={{ position: "absolute",width:"100%",gap:1, color: "colors.white0", bottom: "40px",right: i18n.language === 'ar' ? '20px' : 'unset', 
                                    left: i18n.language === 'en' ? '20px' : 'unset',  fontWeight: 700, zIndex: 11 }}>
