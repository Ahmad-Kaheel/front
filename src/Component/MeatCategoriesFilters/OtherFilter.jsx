  ...
  return (
    <Stack  gap={"65px"} sx={{ paddingY: { xs: "32px", sm: "48px", md: "64px" }, paddingX: { xs: "28px", sm: "32px", md: "128px" }}}>
      ...
      <Swiper
        ...
        dir='rtl'
        slidesPerView={isXs ? 1 : isSm? 1.5 : 2.5}
        initialSlide={1}
        ...
        {slides.map((slide, index) => (
          <SwiperSlide key={index} style={{position:"relative"}}>
            <Box
              ...
              src={slide.img}
            />
            <Typography sx={{position:"absolute",color:"colors.white0",bottom:"20px",left:"50%",fontWeight:700,fontSize:"36px",transform:"translateX(-50%)"}}>{slide.type}</Typography>
          </SwiperSlide>
        ))}
