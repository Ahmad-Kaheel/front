...
const CustomerReview = () => {
    ...
    const slides = [
      { img: user, name: "محمد علام" ,desc:"سرعة في تلبية الطلب وجودة عالية مع لباقة في التعامل من قبل فريق العمل سرعة في تلبية الطلب وجودة عالية مع لباقة في التعامل من قبل فريق العمل سرعة في تلبية الطلب وجودة عالية مع لباقة في التعامل من قبل فريق العمل"},
      ,{ img: user, name: "محمد علام" ,desc:"سرعة في تلبية الطلب وجودة عالية مع لباقة في التعامل من قبل فريق العمل سرعة في تلبية الطلب وجودة عالية مع لباقة في التعامل من قبل فريق العمل سرعة في تلبية الطلب وجودة عالية مع لباقة في التعامل من قبل فريق العمل"},
  ...
  return (
    <Stack gap={{ xs: "32px", sm: "48px", md: "65px" }}  sx={{ paddingY: { xs: "32px", sm: "48px", md: "64px" }, paddingX: { xs: "28px", sm: "32px", md: "128px",lg:"200px",xl:"20%" } }}>
